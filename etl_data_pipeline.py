...
# Configure Logging
logging.basicConfig(filename='E:\Guvi\guvi_project_3\etl_data_pipeline.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')

# AWS Credentials Configuration (Use environment variables or AWS CLI configured credentials)
AWS_ACCESS_KEY = ''
AWS_SECRET_KEY = ''
S3_BUCKET = 'miniproject3'
RAW_DATA_FOLDER = 'Source/'  # Folder in S3 for raw files
TRANSFORMED_DATA_FOLDER = 'Destination/'  # Folder in S3 for transformed files
RDS_ENDPOINT = 'miniproject3.crkwqcomy7as.eu-north-1.rds.amazonaws.com'
RDS_PORT = '3306'
RDS_USER = 'admin'
RDS_PASSWORD = 'miniproject3'
RDS_DB = 'miniproject3'
